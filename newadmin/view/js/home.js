async function homeActive() {
    const userInfo = JSON.parse(sessionStorage.getItem('user'))
    document.querySelector('[name="user"]').innerHTML = `Hello, ${userInfo.firstname}`
...
async function loadDashboardAnalytics() {
    let request = await httpRequest(`../controllers/sms/fetchdashboardstats`, null, null)
