...
<head>
    ...
    <title>KreactiveRock - | programmatic marketing</title>
...
<body>
    ...
    <!-- About Section Start -->
    <div class="bg-amber-50 pt-40 pb-28">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 p-0 m-0">
                    <!-- About Us Image Start -->
                <div class="about-image lg:h-[400px]">
                        <div class="about-img rounded-3xl bg-red-600/10 h-full overflow-hidden">
                            <figure class="w-full h-full">
                                <img src="assets/images/products/pm.jpg" alt="" class="object-cover w-full h-full">
                            </figure>
                        </div>
                    </div>
                    <!-- About Us Image End -->
                ...
                <div class="col-lg-7">
                    ...
                    <div class="about-content">
                        ...
                        <div class="section-title">
                            <h3 class="wow fadeInUp">Programmatic Marketing</h3>
                            <h2 class="text-anime-style-2 font-bold" data-cursor="-opaque">The Programmatic future delivered <span>with Us</span></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.25s"> Revolutionizing Digital Advertising: Our programmatic marketing solutions can help you achieve your digital advertising goals.</p>
                        </div>
                        <!-- Section Title End -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="our-service-content">
                        <!-- Section Title Start -->
                        <div class="section-title">
                            <h2 class="text-anime-style-2 font-bold" data-cursor="-opaque">Marketing <span>Components </span> we Provide
                            </h2>
                            <p class="wow fadeInUp text-muted" data-wow-delay="0.25s">We leverage advanced technologies like artificial intelligence and machine learning to optimize ad placements in real-time, maximizing campaign performance. This approach allows businesses to target specific audiences, measure campaign effectiveness, and achieve better results.</p>
                        </div>
                        <!-- Section Title End -->
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="service-item wow fadeInUp">
                                    <div class="icon-box">
                                        <img src="/assets/images/icon-services-4.svg" alt="" class="w-14">
                                    </div>
                                    <div class="service-body">
                                        <h3>Demand-Side Platform (DSP): </h3>
                                        <p>A platform used by advertisers to buy ad inventory from multiple ad exchanges.</p>
                                    </div>
                                    <div class="service-footer">
                                        <a href="mobile-texting.html"><img src="./assets/images/icon-arrow.svg" alt=""></a>
                                    </div>
                                </div>
                                <!-- Service Item End -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="service-item wow fadeInUp">
                                    <div class="icon-box">
                                        <img src="/assets/images/icon-services-3.svg" alt="" class="w-14">
                                    </div>
                                    <div class="service-body">
                                        <h3>Supply-Side Platform (SSP): </h3>
                                        <p>A platform used by publishers to sell ad inventory to advertisers.</p>
                                    </div>
                                    <div class="service-footer">
                                        <a href="./whatsapp-commerce.html"><img src="./assets/images/icon-arrow.svg" alt=""></a>
                                    </div>
                                </div>
                                <!-- Service Item End -->
                            </div>
    ...
    <div class="about-us pt-40 pb-28">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 p-5 lg:px-72 lg:!py-[100px] rounded-3xl">
                    <!-- About Content Start -->
                    <div class="about-content">
                        <!-- Section Title Start -->
                        <div class="section-title">
                            <h2 class="text-anime-style-2 font-bold text-primary" data-cursor="-opaque">Our programmatic marketing solutions can help you achieve your digital advertising goals</h2>
                            <p class="wow fadeInUp my-10 !text-gray-200" data-wow-delay="0.25s">Scale your campaigns with access to the world’s most premium publishers and reach target consumers wherever they engage with brand-safe content. Buyers can seamlessly execute campaigns on a single platform or across multiple channels with measurable quality that anyone can verify.</p>
                        </div>
                        <!-- Section Title End -->
