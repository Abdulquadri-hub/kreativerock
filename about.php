...
<head>
    ...
    <title>KreactiveRock - | About us</title>
...
<body>
    ...
    <div class="page-about">
        <div class="container">
                    ...
                    <div class="about-us-image">
                        ...
                        <div class="experience-counter-item wow fadeInUp">
                            ...
                            <div class="experience-counter-content">
                                <h3><span class="counter">KreactiveRock</span></h3>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-2 font-bold" data-cursor="-opaque">A digital-first, proactive
                                customer<span> service solution</span></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.25s">We are dedicated to revolutionizing digital
                                communication. With a comprehensive suite of services including Bulk SMS, WhatsApp
                                Campaigns, Sponsored Advertising, Programmatic Marketing, and more, we empower
                                businesses to connect with their audience effectively. Our innovative solutions are
                                designed to enhance engagement, streamline communication, and drive growth. Trusted by
                                thousands of satisfied clients, we are committed to delivering top-notch service and
                                support to help you achieve your marketing goals.</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="about-us-content-body wow fadeInUp" data-wow-delay="0.5s">
                            <ul>
                                <li>Boost engagement with targeted campaigns</li>
                                <li>Tailor your communication strategies.</li>
                                <li>expertise and experience</li>
                                <li>Efficient messaging solutions.</li>
                            </ul>
                        </div>
            ...
            <div class="row trusted-company">
                <div class="col-lg-3">
                    <div class="trusted-companies-title wow fadeInUp">
                        <h3>Trusted by 500+ Companies around the world</h3>
                    </div>
                </div>
                <div class="col-lg-9">
                    <!-- company Carousel Start -->
                    <div class="company-carousel wow fadeInUp">
                        <div class="companies_logo_slider">
                            <swiper-container init="false" class="grayscale">
                                <!-- company Logo Start -->
                                <swiper-slide><img src="assets/images/clients/meta.png" alt=""
                                        class="w-1/3"></swiper-slide>
                                <!-- company Logo End -->
                                <!-- company Logo Start -->
                                <swiper-slide><img src="assets/images/clients/whatsapp.png" alt="" class="w-1/2">
                                </swiper-slide>
                                <!-- company Logo End -->
                                <!-- company Logo Start -->
                                <swiper-slide><img src="assets/images/clients/gushup.png" alt=""
                                        class="w-1/2"></swiper-slide>
                                <!-- company Logo End -->
                                <!-- company Logo Start -->
                                <swiper-slide><img src="assets/images/clients/flutterwave.png" alt=""
                                        class="w-1/2"></swiper-slide>
                                <!-- company Logo End -->
                                <!-- company Logo Start -->
                                <swiper-slide><img src="assets/images/icon-company-logo-5.svg" alt=""
                                        class="w-1/2"></swiper-slide>
                                <!-- company Logo End -->
                                <!-- company Logo Start -->
                                <swiper-slide><img src="assets/images/clients/paystack.png" alt=""
                                        class="w-1/2"></swiper-slide>
                                <!-- company Logo End -->
                            </swiper-container>
                        </div>
    ...
    <!-- Our Services Section Start from seore -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="our-service-content">
                        <!-- Section Title Start -->
                        <div class="section-title">
                            <h2 class="text-anime-style-2 font-bold" data-cursor="-opaque">Our <span>focus</span>
                                Products
                            </h2>
                            <p class="wow fadeInUp text-muted" data-wow-delay="0.25s">Whether you are looking to send
                                notifications to your users or open an interactive session with them, our messaging API
                                products give you the flexibility that you need to employ the right solution.</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="service-item wow fadeInUp">
                                    <div class="icon-box">
                                        <img src="./assets/images/products/bulk_sms.svg" alt="" class="w-14">
                                    </div>
                                    <div class="service-body">
                                        <h3>Two-Way Texting</h3>
                                        <p>Send branded messages to multiple numbers and open a two-way line of
                                            communication with your users.</p>
                                    </div>
                                    <div class="service-footer">
                                        <a href="mobile-texting"><img src="./assets/images/icon-arrow.svg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <!-- Service Item End -->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="service-item wow fadeInUp">
                                    <div class="icon-box">
                                        <img src="./assets/images/products/broadcast.png" alt="" class="w-14">
                                    </div>
                                    <div class="service-body">
                                        <h3>WhatsApp Commerce</h3>
                                        <p>Broadcast messages to your users on WhatsApp, keeping them informed and
                                            engaged.</p>
                                    </div>
                                    <div class="service-footer">
                                        <a href="whatsapp-commerce"><img src="./assets/images/icon-arrow.svg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <!-- Service Item End -->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="service-item wow fadeInUp">
                                    <div class="icon-box">
                                        <img src="./assets/images/products/programmatic.png" alt="" class="w-14">
                                    </div>
                                    <div class="service-body">
                                        <h3>Programmatic Marketing</h3>
                                        <p>Automate your ad buying process with our programmatic marketing solutions.
                                        </p>
                                    </div>
                                    <div class="service-footer">
                                        <a href="programmatic-marketing"><img src="./assets/images/icon-arrow.svg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <!-- Service Item End -->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="service-item wow fadeInUp">
                                    <div class="icon-box">
                                        <img src="./assets/images/products/project-manager.png" alt="" class="w-14">
                                    </div>
                                    <div class="service-body">
                                        <h3>Social Media Management</h3>
                                        <p>Manage your social media presence effectively to boost engagement and grow
                                            your audience.</p>
                                    </div>
                                    <div class="service-footer">
                                        <a href="social-media-management"><img src="./assets/images/icon-arrow.svg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <!-- Service Item End -->
            ...
            <div class="grid lg:grid-cols-2 items-center gap-6">
                <div class="lg:ms-5 ms-8">
                    ...
                    <h2 class="text-3xl md:text-4xl/tight font-semibold text-black mt-4">Get Started In Minutes:
                        Click on register, Create Your Profile</h2>
                    <p class="text-base font-normal text-muted mt-6">With a comprehensive suite of services including
                        Bulk SMS, WhatsApp Campaigns, Sponsored Advertising, Programmatic Marketing, and more, we
                        empower businesses to connect with their audience effectively.</p>
                    ...
                    <div class="grid lg:grid-cols-3 grid-cols-1 gap-8 mt-9">
                        ...
                        <div class="">
                            ...
                            <h1 class="text-xl font-semibold pt-6">1. Click</h1>
                            <p class="text-base text-gray-600 font-normal mt-2">Get started by visiting the registration
                                page.</p>
                        </div>
                        ...
                        <div class="">
                            ...
                            <p class="text-base text-gray-600 font-normal mt-2">Explore all benefits and features
                                available.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    <img src="assets/images/app-image.png" class="h-[600px] rounded-xl mx-auto" alt="feature-image">
                </div>
    ...
    <div class="why-choose-us">
        <div class="container bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 p-5 lg:px-72 lg:!py-[100px] rounded-3xl">
            <div class="row section-row">
                <div class="col-lg-12">
                    <!-- Section Title Start -->
                    <div class="section-title">
                        <h3 class="wow fadeInUp">why us?</h3>
                        <h2 class="text-anime-style-2 text-white font-bold" data-cursor="-opaque">Why you will <span>choose us</span></h2>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="faq-accordion why-choose-accordion" id="accordion">
                        <!-- How It Work Item Start -->
                        <div class="accordion-item wow fadeInUp">
                            <div class="accordion-header">
                                <div class="icon-box">
                                    <img src="assets/images/icon-why-choose-accordian-1.svg" alt="">
                                </div>
                                <h2 id="headingOne">
                                    <button class="accordion-button !text-white" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <span>01</span>Unmatched Expertise
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body !text-gray-200 !visible">
                                    <p>Our team of seasoned experts has a deep understanding of the digital advertising landscape.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.25s">
                            <div class="accordion-header">
                                <div class="icon-box">
                                    <img src="assets/images/icon-why-choose-accordian-2.svg" alt="">
                                </div>
                                <h2 id="headingTwo">
                                    <button class="accordion-button !text-white" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                        <span>02</span> Cutting-Edge Technology
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordion">
                                <div class="accordion-body !text-gray-200 !visible">
                                    <p>We leverage the latest technology and AI-powered tools to deliver superior results</p>
                                </div>
                            </div>
                        </div>
                        <!-- How It Work Item End -->
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.5s">
                            <div class="accordion-header">
                                <div class="icon-box">
                                    <img src="assets/images/icon-why-choose-accordian-3.svg" alt="">
                                </div>
                                <h2 id="headingThree">
                                    <button class="accordion-button !text-white" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseThree" aria-expanded="true"
                                        aria-controls="collapseThree">
                                        <span>03</span> Data-Driven Insights
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordion">
                                <div class="accordion-body !text-gray-200 !visible">
                                    <p>Data is at the heart of our approach. We use data-driven insights to optimize every campaign.</p>
                                </div>
                            </div>
                        </div>
                        <!-- How It Work Item End -->
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.75s">
                            <div class="accordion-header">
                                <div class="icon-box">
                                    <img src="assets/images/icon-why-choose-accordian-4.svg" alt="">
                                </div>
                                <h2 id="headingFour">
                                    <button class="accordion-button !text-white" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseFour" aria-expanded="true"
                                        aria-controls="collapseFour">
                                        <span>04</span>Transparent Reporting
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                data-bs-parent="#accordion">
                                <div class="accordion-body !text-gray-200 !visible">
                                    <p>We provide clear and transparent reporting, giving you full visibility into your campaign performance.</p>
                                </div>
                            </div>
                        </div>
                        <!-- How It Work Item End -->
                            ...
                            <div class="accordion-header">
                                ...
                                <h2 id="headingFive">
                                    <button class="accordion-button !text-white" type="button" data-bs-toggle="collapse"
                                        ...
                                        <span>05</span>Exceptional Customer Service
                                    </button>
                                </h2>
                            </div>
                    ...
                    <div class="hs-accordion-group divide-y divide-gray-200">
                        <div class="relative overflow-hidden">
                            ...
                            <div id="accordion-collapse-body-1" class="hidden"
                                ...
                                <div class="px-5 pb-5">
                                    <p class="text-muted text-base font-normal">RCS (Rich Communication Services) is the
                                        next generation of SMS messaging. It offers a more advanced messaging
                                        experience, allowing for richer content like high-quality images, videos, and
                                        interactive features. RCS messages can be personalized, interactive, and deliver
                                        a more engaging experience than traditional SMS.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative overflow-hidden">
                            ...
                            <div id="accordion-collapse-body-2" class="hidden"
                                ...
                                <div class="px-5 pb-5">
                                    <p class="text-muted text-base font-normal">Our WhatsApp Business API allows
                                        businesses to automate customer interactions, send personalized messages, and
                                        provide 24/7 support. To use our API, you'll need to be approved by WhatsApp and
                                        integrate our API into your business systems. We provide comprehensive
                        ...
                        <div class="relative overflow-hidden">
                            ...
                            <div id="accordion-collapse-body-3" class="hidden"
                                ...
                                <div class="px-5 pb-5">
                                    <p class="text-muted text-base font-normal">Our SMS services offer a reliable and
                                        cost-effective way to reach your target audience. With our SMS platform, you can
                                        send bulk SMS, SMS marketing campaigns, and SMS verification codes. We offer a
                                        variety of features, including SMS scheduling, delivery reports, and
                                        international SMS.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative overflow-hidden">
                            ...
                            <div id="accordion-collapse-body-4" class="hidden"
                                ...
                                <div class="px-5 pb-5">
                                    <p class="text-muted text-base font-normal">Our messaging services can help you
                                        improve customer engagement by providing a seamless and personalized
                                        communication experience. By using RCS, WhatsApp, and SMS, you can deliver
                                        timely and relevant messages to your customers. You can also use our platform to
                                        gather customer feedback and insights.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative overflow-hidden">
                            ...
                            <div id="accordion-collapse-body-5" class="hidden"
                                ...
                                <div class="px-5 pb-5">
                                    <p class="text-muted text-base font-normal">Our pricing is competitive and varies
                                        depending on the specific services you choose. We offer flexible pricing plans
                                        to suit your business needs. Contact our sales team for a customized quote.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="lg:w-4/5 mx-auto">
                ...
                <div class="max-w-2xl mx-auto text-center">
                    <h2 class="text-3xl md:text-4xl/tight font-semibold text-black mt-4">Ready? Lets get you started
                    </h2>
                        ...
                        <form>
                            <div class="grid sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                        class="block w-full text-sm rounded-md py-3 px-4 border-gray-200 focus:border-gray-300 focus:ring-transparent"
                                        id="companyname" placeholder="Your company name..." required=""
                                        name="companyname">
                                </div>

                                <div>
                                    <label for="companyposition"
                                        class="block text-sm/normal font-semibold text-black mb-2">Company
                                        Position</label>
                                    <input type="text"
                                        class="block w-full text-sm rounded-md py-3 px-4 border-gray-200 focus:border-gray-300 focus:ring-transparent"
                                        id="companyposition" placeholder="Your company position..." required=""
                                        name="companyposition">
                                </div>

                                <div>
                                    <label for="email" class="block text-sm/normal font-semibold text-black mb-2">Email
                                        Address</label>
                                    <input type="email"
                                        class="block w-full text-sm rounded-md py-3 px-4 border-gray-200 focus:border-gray-300 focus:ring-transparent"
                                ...
                                <div>
                                    <label for="phone" class="block text-sm/normal font-semibold text-black mb-2">Phone
                                        Number</label>
                                    <input type="text"
                                        class="block w-full text-sm rounded-md py-3 px-4 border-gray-200 focus:border-gray-300 focus:ring-transparent"
                                ...
                                <div>
                                    <label for="website" class="text-sm/normal font-semibold text-black mb-2">Website
                                        URL</label>
                                    <input type="url"
                                        class="block w-full text-sm rounded-md py-3 px-4 border-gray-200 focus:border-gray-300 focus:ring-transparent"
                                ...
                                <div class="sm:col-span-2">
                                    <div class="mb-4">
                                        ...
                                        <textarea
                                            class="block w-full text-sm rounded-md py-3 px-4 border-gray-200 focus:border-gray-300 focus:ring-transparent"
                                            id="message" rows="4" placeholder="Type messages..." required=""
