...
!function() {
    ...
    var R = {
        slideTo: function(e, t, s, i, a) {
            ...
            if (!f && !i && !a || r.destroyed || r.animating && l.preventInteractionOnTransition)
                return !1;
            ...
            s)
                if (y.length > 0 && T) {
                    if (void 0 === t) {
                        ...
                        l ? o.setTranslate(o.translate - t) : (o.slideTo(E + Math.ceil(M), 0, !1, !0),
    ...
    function q(e) {
        ...
        let c = a.target;
        if ("wrapper" === l.touchEventsTarget && (u = c,
        !f(t.wrapperEl).includes(u)))
            return;
        var u;
        ...
        m && a.target && a.target.shadowRoot && h && (c = h[0]);
        const g = l.noSwipingSelector ? l.noSwipingSelector : `.${l.noSwipingClass}`
          , v = !(!a.target || !a.target.shadowRoot);
        ...
        let y = !0;
        c.matches(n.focusableElements) && (y = !1,
        ...
        const x = y && t.allowTouchMove && l.touchStartPreventDefault;
        !l.touchStartForcePreventDefault && !x || c.isContentEditable || a.preventDefault(),
    ...
    function V(e) {
        ...
        for (let e = 0; e < p.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
            ...
            void 0 !== p[e + t] ? (f || h >= p[e] && h < p[e + t]) && (g = e,
            v = p[e + t] - p[e]) : (f || h >= p[e]) && (g = e,
            v = p[p.length - 1] - p[p.length - 2])
        }
        let w = null
          , b = null;
        ...
        if (m > r.longSwipesMs) {
            ...
            "prev" === t.swipeDirection && (y > 1 - r.longSwipesRatio ? t.slideTo(g + x) : null !== b && y < 0 && Math.abs(y) > r.longSwipesRatio ? t.slideTo(b) : t.slideTo(g))
        } else {
            if (!r.shortSwipes)
                return void t.slideTo(t.activeIndex);
            t.navigation && (a.target === t.navigation.nextEl || a.target === t.navigation.prevEl) ? a.target === t.navigation.nextEl ? t.slideTo(g + x) : t.slideTo(g) : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : g + x),
    ...
    const Q = (e, t) => {
        ...
        a.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", j, !0) : e[p]("observerUpdate", j, !0),
        r[d]("load", e.onLoad, {
            capture: !0
        }))
    }
    ...
    const ge = [function(e) {
        ...
        function p(e, t) {
            ...
            r ? (y = Math.floor(i / 2) + a + c,
            x = Math.floor(i / 2) + a + p) : (y = i + (a - 1) + c,
            x = (l ? i : a) + p);
            let E = w - x
              , S = w + y;
            l || (E = Math.max(E, 0),
    ...
    , function(e) {
        ...
        i("init", ( () => {
            !1 === t.params.navigation.enabled ? u() : (p(),
            l())
        }
        )),
        ...
        i("click", ( (e, s) => {
            ...
            if (t.params.navigation.hideOnClick && !l) {
                if (t.pagination && t.params.pagination && t.params.pagination.clickable && (t.pagination.el === n || t.pagination.el.contains(n)))
                    return;
                let e;
                i.length ? e = i[0].classList.contains(t.params.navigation.hiddenClass) : r.length && (e = r[0].classList.contains(t.params.navigation.hiddenClass)),
            ...
            "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                p.length > 1)
                    a.forEach((e => {
                        ...
                        s.dynamicBullets && (a >= o && a <= c && e.classList.add(...`${s.bulletActiveClass}-main`.split(" ")),
                        a === o && d(e, "prev"),
                        a === c && d(e, "next"))
                    }
                    ));
    ...
    , function(e) {
        ...
        function P() {
            ...
            a && (r = a.querySelector(ne(t.params.scrollbar.dragClass)),
        ...
        a("init", ( () => {
            !1 === t.params.scrollbar.enabled ? z() : (P(),
            b(),
            g())
        }
        )),
        ...
        function w(e) {
            ...
            if (!t.pagination || !t.pagination.el || i !== t.pagination.el && !t.pagination.el.contains(e.target) || e.target.matches(ne(t.params.pagination.bulletClass))) {
                if (t.navigation && t.navigation.prevEl && t.navigation.nextEl) {
                    ...
                    T(t.navigation.nextEl).includes(i) && (t.isEnd && !t.params.loop || t.slideNext(),
                    t.isEnd ? d(s.lastSlideMessage) : d(s.nextSlideMessage)),
                    e.includes(i) && (t.isBeginning && !t.params.loop || t.slidePrev(),
        ...
        a("paginationUpdate", ( () => {
            t.params.a11y.enabled && function() {
                ...
                b() && t.pagination.bullets.forEach((s => {
                    t.params.pagination.clickable && (p(s),
    ...
    , function(e) {
        ...
        n("destroy", ( () => {
            a.el && "string" != typeof a.el && (a.el.removeEventListener("pointerenter", L),
    ...
    , function(e) {
        ...
        ue({
            ...
            setTranslate: () => {
                ...
                let h, f = 0;
                c.shadow && (u ? (h = t.wrapperEl.querySelector(".swiper-cube-shadow"),
    ...
    function be(e, t) {
        ...
        Object.keys(t).filter((e => s.indexOf(e) < 0)).forEach((s => {
            void 0 === e[s] ? e[s] = t[s] : we(t[s]) && we(e[s]) && Object.keys(t[s]).length > 0 ? t[s].__swiper__ ? e[s] = t[s] : be(e[s], t[s]) : e[s] = t[s]
        }
        ))
    }
    function ye(e) {
    ...
    const xe = e => {
      ...
      , Ee = ["a11y", "autoplay", "controller", "cards-effect", "coverflow-effect", "creative-effect", "cube-effect", "fade-effect", "flip-effect", "free-mode", "grid", "hash-navigation", "history", "keyboard", "mousewheel", "navigation", "pagination", "parallax", "scrollbar", "thumbs", "virtual", "zoom"];
    function Se(e, t, s) {
        const i = {}
          , a = {};
        be(i, ee);
        ...
        l.forEach((e => {
            ...
            if (t) {
                ...
                if (!n.includes(t))
                    return;
                const s = xe(e.value);
                a[t] && Ee.includes(e.name) && !we(s) ? (a[t].constructor !== Object && (a[t] = {}),
                a[t].enabled = !!s) : a[t] = s
            }
        }
        )),
    ...
    : HTMLElement
      , Ce = '<svg width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.38296 20.0762C0.111788 19.805 0.111788 19.3654 0.38296 19.0942L9.19758 10.2796L0.38296 1.46497C0.111788 1.19379 0.111788 0.754138 0.38296 0.482966C0.654131 0.211794 1.09379 0.211794 1.36496 0.482966L10.4341 9.55214C10.8359 9.9539 10.8359 10.6053 10.4341 11.007L1.36496 20.0762C1.09379 20.3474 0.654131 20.3474 0.38296 20.0762Z" fill="currentColor"/></svg>\n    '
      , Pe = (e, t) => {
    ...
    class Le extends Me {
        ...
        static get observedAttributes() {
            return ve.filter((e => e.includes("_"))).map((e => e.replace(/[A-Z]/g, (e => `-${e}`)).replace("_", "").toLowerCase()))
        }
    }
    ve.forEach((e => {
    ...
    "undefined" != typeof window && (window.customElements.get("swiper-container") || window.customElements.define("swiper-container", Le),
