        ...
        <div class="xl:bg-white xl:border w-full md:w-2/3 xl:w-1/3 3xl:w-1/5 mx-auto rounded py-14 px-12 drop-shadow-sm">
            ...
            <form class="mt-10" id="loginform" autocomplete="off">
                <div>
                   ...
                   <div class="border-t rounded-b flex items-center  bg-[#fafafa] relative">
                        <span class="h-14 w-14 flex">
                        ...
                        <span class="flex flex-col space-y-1 ">
                            ...
                            <input name="" id="password" type="password" placeholder="******" class="placeholder:text-xs placeholder:text-gray-500 font-semibold text-sm focus:outline-none focus:ring-0 focus:border-transparent bg-transparent w-[294px]">
                            <span id="pvisible" class="material-symbols-outlined absolute cursor-pointer" style="right: 3px;top:15px">visibility_off</span>
                        </span>
                    </div>
                   <div class="flex items-center justify-between my-5 text-xs text-gray-400 font-normal tracking-wide">
                        <span class="flex items-center space-x-1">
                            <input type="checkbox" checked class="accent-primary-g">
                    ...
                    <div class="flex gap-3 3xl:gap-1 flex-col md:flex-row items-center mt-10">
                        <button id="submit" type="button" class="w-full md:w-max rounded-full text-white text-sm capitalize bg-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
