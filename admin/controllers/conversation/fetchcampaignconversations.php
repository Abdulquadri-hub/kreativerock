...
// $results =  $conversation->getCampaignUsersList($campaignId, $email);
if(!empty($results)){
    echo json_encode(['status' => true, 'code' => 200, 'message' => "Campaign conversation fetched successfully", 'data' => $results]);
}else{
    echo json_encode(['status' => false, 'code' => 404, 'message' => "Campaign conversation not found", 'data' => $results]);
}
